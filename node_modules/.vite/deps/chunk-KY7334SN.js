    ...
    if (dependencies !== null) {
      ...
      if ((is_disconnected || is_unowned_connected) && (active_effect === null || (active_effect.f & DESTROYED) === 0)) {
        ...
        for (i = 0; i < length; i++) {
          ...
          if (is_disconnected || !((_a = dependency == null ? void 0 : dependency.reactions) == null ? void 0 : _a.includes(derived3))) {
...
function get(signal) {
  ...
  if (is_destroying_effect) {
    ...
    derived3 = /** @type {Derived} */
    signal;
    if ((_c = batch_deriveds) == null ? void 0 : _c.has(derived3)) {
...
//# sourceMappingURL=chunk-KY7334SN.js.map
